...
class HomePage extends Page {
  ...
  async openAdminTab() {
    await customActions.waitForBtnAndClick(this.adminTab);
  }

  async addUserBtnClick() {
    await customActions.waitForBtnAndClick(this.btnAdd);
  }
  ...
  async waitForHomepageLoaded() {
    await this.currentUserName.waitForDisplayed({ timeout: 10000 });
  }
}
